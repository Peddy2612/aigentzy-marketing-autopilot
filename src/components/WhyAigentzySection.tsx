...
const StatementSection = ({ statement, index }: { statement: any, index: number }) => {
      ...
      case 'efficiency':
        return (
          <div className="grid grid-cols-3 gap-6">
            {['Analyse', 'Optimierung', 'Umsetzung'].map((step, i) => (
              <motion.div 
                key={step}
                className="bg-aigentzy-light-violet/20 rounded-2xl p-6 text-center"
              ...
              >
                ...
                <motion.div 
                  className="text-3xl font-bold text-aigentzy-deep-violet"
  ...
  return (
    <section 
      ref={ref}
      className="min-h-screen flex items-center justify-center py-20 sticky top-0 bg-aigentzy-light-violet/10"
